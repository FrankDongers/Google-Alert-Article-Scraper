...
#poliblogs <- poliblogs[which(poliblogs$time=='2018.09' | poliblogs$time=='2018.12' | poliblogs$time=='2019.03'| poliblogs$time=='2019.06'| poliblogs$time=='2019.09'),]
...
docMatrix<-First_STM[["theta"]]
matrix.df <- as.data.frame((docMatrix))
write.csv(matrix.df,"/Users/FrankMAC/Desktop/Google-Alert-Link-Grabber/model/output/docMatrix.csv", row.names = FALSE)

perplexity(First_STM)